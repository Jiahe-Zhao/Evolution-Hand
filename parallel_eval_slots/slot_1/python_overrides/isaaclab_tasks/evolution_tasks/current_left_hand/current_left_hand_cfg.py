...
ASSET_PATH = os.path.join(EVOLUTION_ROOT, 'parallel_eval_slots/slot_1/agent_for_isaaclab_mirror/urdf/current_agent.urdf')

# Configuration based on URDF file /home/zjh/Evolution_PC/parallel_eval_slots/slot_1/agent_for_isaaclab_mirror/urdf/current_agent.urdf
