...
experiment_save_path = "exp_2026box_2" # 保存谱系图的路径
...
if check_point == "human":
    from human_hand_agent_box import initial_agent_hand
elif check_point == "human_box_all":
    from human_hand_agent_box_all import initial_agent_hand
...
successful_generations = 0  # 连续成功代数（跨 generation 持续）

# Ensure result roots exist to avoid FileNotFoundError when reading latest logs.
for result_root in isaaclab_test_result_path:
