...
if TYPE_CHECKING:
    ...
    from isaaclab_tasks.direct.evolution_hand_different_demo.demo_hand_env_cfg import DEMO_HAND_CFG

# 非基于管理器的，而是直接模式，继承了DirectRLEnv   DirectRLEnv里面有很多要改的
class InHandManipulationEnv(DirectRLEnv):
    cfg: DEMO_HAND_CFG | ShadowHandEnvCfg  # 适用于AllegroHand和ShadowHand

    def __init__(self, cfg: DEMO_HAND_CFG | ShadowHandEnvCfg, render_mode: str | None = None, **kwargs):
