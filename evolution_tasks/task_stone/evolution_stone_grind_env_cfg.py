...
class EvolutionStoneGrindEnvCfg(DirectMARLEnvCfg):
    ...
    fall_penalty = 0
    # Region-only palm labels: no additional palm collision geometry is used.
    left_palm_region_center = (0.010, 0.0, 0.016)
    right_palm_region_center = (0.010, 0.0, 0.016)
    palm_region_half_extents = (0.035, 0.035, 0.026)
    palm_region_reward_scale = 2.0
    grasp_dist = 0.025
    success_tolerance = 1
