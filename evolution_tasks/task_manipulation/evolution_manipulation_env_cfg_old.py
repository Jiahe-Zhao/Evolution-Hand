...
class EvolutionManipulationEnvCfg(DirectRLEnvCfg):
    ...
    #grasp_hand 位置还得改 左手
    robot_cfg: ArticulationCfg = LEFT_HAND_CFG.replace(prim_path="/World/envs/env_.*/Robot").replace(
    ...
    object_cfg: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            ...
            usd_path=f"/share/home/zjh/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/evolution_tasks/task_manipulation/DexCube/dex_cube_new.usd",
